...
_ROBOT_DATA = [
    ("1042", "Active",      "SMT Assembly - Alpha",   85, 12.4),
    ("1043", "Active",      "SMT Assembly - Alpha",   78, 12.4),
    ("1088", "Calibrating", "Inspection - Beta",      92,  0.2),
    ("1091", "Active",      "Packaging - Gamma",      45,  8.1),
    ("1105", "Offline",     "Heavy Payload - Delta",  12,  0.0),
    ("1106", "Active",      "Heavy Payload - Delta",  88,  5.5),
    ("1122", "Active",      "SMT Assembly - Beta",    67,  9.2),
    ("1123", "Active",      "SMT Assembly - Beta",    95,  2.1),
]
...
layout = html.Div(
    [
        ...
        dbc.Row([
            dbc.Col(
                dbc.Button(
                    [html.I(className="bi bi-arrow-clockwise me-2"), "Refresh Status"],
                    id="btn-refresh", color="primary", outline=True, className="mb-4",
                ),
                width="auto",
            ),
            dbc.Col(
        ...
        html.Div(id="fleet-last-updated", className="text-muted small mb-3"),

        dbc.Row(
            id="fleet-robot-grid",
            children=[generate_robot_card(*args) for args in _ROBOT_DATA],
        ),
    ],
...
@callback(
    Output("fleet-last-updated", "children"),
